...
<body>
    ...
    <?php if (isset($_SESSION['pesan_error'])) { echo "<p style='color:red;'>" . $_SESSION['pesan_error'] . "</p>"; unset($_SESSION['pesan_error']); } ?>
    ...
    <form action="proses_tambah_keranjang.php" method="POST">
        ...
        <select name="id_barang" required>
            ...
            <?php while ($b = mysqli_fetch_assoc($daftar_barang)) { ?>
                <option value="<?php echo $b['id_barang']; ?>"><?php echo $b['nama_barang']; ?> (Stok: <?php echo $b['stok']; ?>)</option>
            <?php } ?>
        </select>
